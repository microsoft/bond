    ...
    class ExampleServiceImpl final : Example::Service
    {
        void ExampleMethod(
            bond::ext::gRPC::unary_call<
                ...
                bond::bonded<ExampleResponse>> call) override
        {
...
straightforward API for aynchronous communication than gRPC currently presents
in C++. The use of `wait_callback<T>` here is for illustrative purposes; any
