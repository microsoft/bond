...
class LayerTransportTests
{
    ...
    void Server1Service1Layer0()
    {
        ...
        // Start transport.
        //
        bond::comm::v2::LayerTransport<Transport, bond::comm::CompactWireProtocol>  transport;
    ...
    struct Layer1
      : public bond::comm::v2::OnReceiveLayerService< Data >
      , public bond::comm::v2::OnSendLayerService< Data >
    {
    ...
    void Server1Service1Layer1()
    {
        ...
        //
        bond::comm::v2::LayerStack<Data, Layer1, Layer2> layers(layer1, layer2);

        //
        // Start transport.
        //
        bond::comm::v2::LayerTransport<Transport, bond::comm::CompactWireProtocol>  transport(layers);
