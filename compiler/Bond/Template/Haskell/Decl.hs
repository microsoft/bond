...
declTypeInfo ::
             Bond.Template.TypeMapping.Context ->
               Declaration -> (QualifiedName, String)
...
declModule ::
           Bond.Template.TypeMapping.Context -> Declaration -> ModuleName
declModule mapping = uncurry mkModuleName . declTypeInfo mapping
 
hsType ::
       Bond.Template.TypeMapping.Context ->
         Bond.Schema.Type -> Language.Haskell.Exts.Type
...
defaultInstance ::
                Bond.Template.TypeMapping.Context -> Declaration -> Decl
