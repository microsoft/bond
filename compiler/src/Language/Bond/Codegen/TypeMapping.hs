...
javaBox BT_Blob = pure "java.util.ArrayList<byte>"
...
javaType (BT_List element) = "java.util.LinkedList<" <>> elementTypeName element <<> ">"
javaType (BT_Vector element) = "java.util.ArrayList<" <>> elementTypeName element <<> ">"
javaType (BT_Set element) = "java.util.HashSet<" <>> elementTypeName element <<> ">"
javaType (BT_Map key value) = "java.util.HashMap<" <>> elementTypeName key <<>> ", " <>> elementTypeName value <<> ">"
