    ...
    struct foo::Schema
    {
        ...
        public: struct var
        {
            ...
            typedef struct : ::bond::reflection::FieldTemplate<
                ...
                ::bond::reflection::optional_field_modifier,
                foo,
                std::set<int32_t, std::less<int32_t>, std::scoped_allocator_adaptor<typename std::allocator_traits<allocator_type>::template rebind_alloc<int32_t> > >,
                &foo::s,
                &s_s_metadata
            > {}  s;
        };
