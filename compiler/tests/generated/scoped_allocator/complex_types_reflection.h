    ...
    struct ComplexTypes::Schema
    {
        ...
        public: struct var
        {
            ...
            typedef struct : ::bond::reflection::FieldTemplate<
                ...
                ComplexTypes,
                std::list<int8_t, std::scoped_allocator_adaptor<typename std::allocator_traits<allocator_type>::template rebind_alloc<int8_t> > >,
                &ComplexTypes::li8,
                &s_li8_metadata
            > {}  li8;
            ...
            typedef struct : ::bond::reflection::FieldTemplate<
                ...
                ::bond::reflection::optional_field_modifier,
                ComplexTypes,
                std::set<bool, std::less<bool>, std::scoped_allocator_adaptor<typename std::allocator_traits<allocator_type>::template rebind_alloc<bool> > >,
                &ComplexTypes::sb,
                &s_sb_metadata
            > {}  sb;
            ...
            typedef struct : ::bond::reflection::FieldTemplate<
                ...
                ::bond::reflection::optional_field_modifier,
                ComplexTypes,
                std::vector< ::bond::blob, std::scoped_allocator_adaptor<typename std::allocator_traits<allocator_type>::template rebind_alloc< ::bond::blob> > >,
                &ComplexTypes::vb,
                &s_vb_metadata
            > {}  vb;
