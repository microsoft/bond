...
namespace Bond.Comm.Epoxy
{
    ...
    internal class EpoxyNetworkStream
    {
            ...
            Logger logger)
        {
            ...
            {
                // If client certificates are required, then add an expicit check
                // that the client provided a certificate. The default behavior is
                // to allow the connection even if the client didn't present a
                // certificate.
