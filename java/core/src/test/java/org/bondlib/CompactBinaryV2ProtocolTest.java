...
public class CompactBinaryV2ProtocolTest {
    ...
    public void testMultiListFieldStruct() {
        byte[] payload = new byte[]{
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 12,
                (byte) (BondDataType.BT_INT8.value | (3 << 5)),
                (byte) 0x02,
                (byte) 0x03,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 30,
                (byte) (BondDataType.BT_INT32.value | (1 << 5)),

                // 31 : list<int32> = {0x00000001}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 31,
                (byte) (BondDataType.BT_INT32.value | (2 << 5)),
                (byte) 0x02,

                // 32 : list<int32> = {0x00000002, 0x00000003}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 32,
                (byte) (BondDataType.BT_INT32.value | (3 << 5)),
                (byte) 0x04,
                (byte) 0x06,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 40,
                (byte) (BondDataType.BT_INT64.value | (1 << 5)),

                // 41 : list<int64> = {0x0000000000000001}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 41,
                (byte) (BondDataType.BT_INT64.value | (2 << 5)),
                (byte) 0x02,

                // 42 : list<int64> = {0x0000000000000002, 0x0000000000000003}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 42,
                (byte) (BondDataType.BT_INT64.value | (3 << 5)),
                (byte) 0x04,
                (byte) 0x06,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 60,
                (byte) (BondDataType.BT_UINT16.value | (1 << 5)),

                // 61 : list<uint16> = {0x0001}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 61,
                (byte) (BondDataType.BT_UINT16.value | (2 << 5)),
                (byte) 0x01,

                // 62 : list<uint16> = {0x0002, 0x0003}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 62,
                (byte) (BondDataType.BT_UINT16.value | (3 << 5)),
                (byte) 0x02,
                (byte) 0x03,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 70,
                (byte) (BondDataType.BT_UINT32.value | (1 << 5)),
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 72,
                (byte) (BondDataType.BT_UINT32.value | (3 << 5)),
                (byte) 0x02,
                (byte) 0x03,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 80,
                (byte) (BondDataType.BT_UINT64.value | (1 << 5)),

                // 81 : list<uint64> = {0x0000000000000001}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 81,
                (byte) (BondDataType.BT_UINT64.value | (2 << 5)),
                (byte) 0x01,

                // 82 : list<uint64> = {0x0000000000000002, 0x0000000000000003}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 82,
                (byte) (BondDataType.BT_UINT64.value | (3 << 5)),
                (byte) 0x02,
                (byte) 0x03,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 90,
                (byte) (BondDataType.BT_BOOL.value | (1 << 5)),

                // 91 : list<bool> = {false}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 91,
                (byte) (BondDataType.BT_BOOL.value | (2 << 5)),
                (byte) 0x00,

                // 92 : list<bool> = {false, true}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 92,
                (byte) (BondDataType.BT_BOOL.value | (3 << 5)),
                (byte) 0x00,
                (byte) 0x01,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 100,
                (byte) (BondDataType.BT_FLOAT.value | (1 << 5)),

                // 101 : list<float> = {0}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 101,
                (byte) (BondDataType.BT_FLOAT.value | (2 << 5)),
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,

                // 102 : list<float> = {0, -0}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 102,
                (byte) (BondDataType.BT_FLOAT.value | (3 << 5)),
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 110,
                (byte) (BondDataType.BT_DOUBLE.value | (1 << 5)),

                // 111 : list<double> = {0}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 111,
                (byte) (BondDataType.BT_DOUBLE.value | (2 << 5)),
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,

                // 112 : list<double> = {0, -0}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 112,
                (byte) (BondDataType.BT_DOUBLE.value | (3 << 5)),
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 120,
                (byte) (BondDataType.BT_STRING.value | (1 << 5)),

                // 121 : list<string> = {""}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 121,
                (byte) (BondDataType.BT_STRING.value | (2 << 5)),
                (byte) 0,

                // 122 : list<string> = {"", "test"}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 122,
                (byte) (BondDataType.BT_STRING.value | (3 << 5)),
                (byte) 0,
                (byte) 4,
                (byte) 't',
                (byte) 'e',
                ...
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 130,
                (byte) (BondDataType.BT_WSTRING.value | (1 << 5)),

                // 131 : list<wstring> = {""}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 131,
                (byte) (BondDataType.BT_WSTRING.value | (2 << 5)),
                (byte) 0,

                // 132 : list<wstring> = {"", "test"}
                (byte) (BondDataType.BT_LIST.value | 0xC0),
                (byte) 132,
                (byte) (BondDataType.BT_WSTRING.value | (3 << 5)),
                (byte) 0,
                (byte) 4,
                (byte) 't', (byte) 0,
                (byte) 'e', (byte) 0,
                ...
                (byte) (BondDataType.BT_STRUCT.value | (2 << 5)),
                (byte) 3,
                (byte) (BondDataType.BT_INT8.value | (0 << 5)),
                (byte) 0xFE,
                (byte) BondDataType.BT_STOP.value,
                ...
                (byte) (BondDataType.BT_STRUCT.value | (4 << 5)),
                (byte) 3,
                (byte) (BondDataType.BT_INT8.value | (0 << 5)),
                (byte) 0xEF,
                (byte) BondDataType.BT_STOP.value,
                ...
                (byte) (BondDataType.BT_INT8.value | (4 << 5)),
                (byte) 0xFA,
                (byte) 0xFB,
                (byte) 0xFC,
                (byte) BondDataType.BT_STOP.value,
                ...
                (byte) (BondDataType.BT_LIST.value | (1 << 5)),

                // 2001 : list<list<?>> = { L1 }
                //        L1: list<uint8> = { 0x0A, 0x0B, 0x0C }
                (byte) (BondDataType.BT_LIST.value | 0xE0),
                (byte) 2001, (byte) (2001 >>> 8),
                (byte) (BondDataType.BT_LIST.value | (2 << 5)),
                (byte) (BondDataType.BT_UINT8.value | (4 << 5)),
                (byte) 0x0A,
                (byte) 0x0B,
                (byte) 0x0C,
                ...
                (byte) (BondDataType.BT_LIST.value | 0xE0),
                (byte) 3000, (byte) (3000 >>> 8),
                (byte) (BondDataType.BT_SET.value | (1 << 5)),

                // 3001 : list<set<?>> = { S1 }
                //        S1: set<uint8> = { 0x0A, 0x0B, 0x0C }
                (byte) (BondDataType.BT_LIST.value | 0xE0),
                (byte) 3001, (byte) (3001 >>> 8),
                (byte) (BondDataType.BT_SET.value | (2 << 5)),
                (byte) (BondDataType.BT_UINT8.value | (4 << 5)),
                (byte) 0x0A,
                (byte) 0x0B,
                (byte) 0x0C,
                ...
                (byte) (BondDataType.BT_MAP.value | (1 << 5)),

                // 4001 : list<map<?, ?>> = { M1 }
                //        M1: map<bool, uint8> = { false -> 0xF0, true -> 0xF1 }
                (byte) (BondDataType.BT_LIST.value | 0xE0),
                (byte) 4001, (byte) (4001 >>> 8),
                (byte) (BondDataType.BT_MAP.value | (2 << 5)),
                ...
                (byte) (BondDataType.BT_MAP.value | (3 << 5)),
                (byte) BondDataType.BT_BOOL.value,
    ...
    public void testLargeFieldStruct() throws IOException {
        ...
        // length
        baos.write(new byte[]{(byte) 0xB3, (byte) 0xC8, (byte) 0x0D});
