...
public class SimpleBinaryV1ProtocolTest {
    ...
    public void testLargeFieldStruct() throws IOException {
        ...
        SimpleBinaryWriter writer = new SimpleBinaryWriter(baos, PROTOCOL_VERSION);

        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeString1.length());
        baos.write(StringHelper.encodeString(UntaggedBinaryTestHelper.LargeSequences.LargeString1));
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeString2.length());
        baos.write(StringHelper.encodeString(UntaggedBinaryTestHelper.LargeSequences.LargeString2));
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeString3.length());
        baos.write(StringHelper.encodeString(UntaggedBinaryTestHelper.LargeSequences.LargeString3));
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeString4.length());
        baos.write(StringHelper.encodeString(UntaggedBinaryTestHelper.LargeSequences.LargeString4));
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeString5.length());
        baos.write(StringHelper.encodeString(UntaggedBinaryTestHelper.LargeSequences.LargeString5));

        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array1.length);
        baos.write(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array1);
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array2.length);
        baos.write(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array2);
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array3.length);
        baos.write(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array3);
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array4.length);
        baos.write(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array4);
        writer.writeInt32(UntaggedBinaryTestHelper.LargeSequences.LargeUInt8Array5.length);
