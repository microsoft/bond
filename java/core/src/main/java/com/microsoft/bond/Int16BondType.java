...
/**
 * Implements the {@link BondType} contract for the Bond "int16" data type.
 */
public final class Int16BondType extends PrimitiveBondType<Short> {
    ...
    protected static short deserializePrimitiveField(
            TaggedDeserializationContext context,
            StructBondType.StructField<Short> field) throws IOException {
        // an int16 value may be deserialized from BT_INT16 or BT_INT8
